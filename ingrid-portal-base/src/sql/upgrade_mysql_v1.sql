...
INSERT INTO `ingrid_cms` (`id`, `item_key`, `item_description`, `item_changed`, `item_changed_by`) VALUES (16, 'portalu.about', 'Über PortalU', '2006-09-15 00:00:00', 'admin');
...
INSERT INTO `ingrid_cms_item` (`id`, `fk_ingrid_cms_id`, `item_lang`, `item_title`, `item_value`, `item_changed`, `item_changed_by`) VALUES (34, 18, 'en', '', '.</p><p>Our address:</p><p>Niedersächsisches Umweltministerium<br />Koordinierungsstelle PortalU<br />Archivstrasse 2<br />D-30169 Hannover<br /></p> <p>Please contact us! We will answer your request as soon as possible. All data you entered will be saved only to process your request.</p>', '2006-09-15 00:00:00', 'admin');
