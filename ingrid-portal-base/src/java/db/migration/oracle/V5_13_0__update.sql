-- DB Version
UPDATE ingrid_lookup SET item_value = '5.13.0', item_date = SYSDATE WHERE ingrid_lookup.item_key ='ingrid_db_version';
...
TRUNCATE TABLE fragment_pref, fragment_pref_value;
