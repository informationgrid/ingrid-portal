...
-- add cms key
INSERT INTO ingrid_cms (item_key, item_description, item_changed_by) VALUES ('portal.cms.portlet.3', 'Anwendungen Übersicht', 'admin');
INSERT INTO ingrid_cms_item (fk_ingrid_cms_id, item_lang, item_title, item_value, item_changed_by) VALUES ((SELECT id FROM ingrid_cms WHERE item_key  = 'portal.cms.portlet.3'), 'de', 'CMSPortlet3', '', 'admin');
INSERT INTO ingrid_cms_item (fk_ingrid_cms_id, item_lang, item_title, item_value, item_changed_by) VALUES ((SELECT id FROM ingrid_cms WHERE item_key  = 'portal.cms.portlet.3'), 'en', 'CMSPortlet3', '', 'admin');
