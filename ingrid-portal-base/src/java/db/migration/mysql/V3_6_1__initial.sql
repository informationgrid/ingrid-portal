...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 28. Mai 2018 um 15:15 (Daten bereinigt)
...
(10, 10, 0, '/WEB-INF/templates/about_links.vm'),
(11, 11, 0, 'about.links.title'),
(12, 12, 0, '/WEB-INF/templates/about_partner.vm'),
...
(1, 'ingrid.teaser.inform', 'PortalU informiert Text', '2017-05-23 12:11:21', 'kst_su'),
(15, 'ingrid.disclaimer', 'Impressum', '2017-05-23 12:11:21', 'admin'),
(16, 'ingrid.about', 'Über PortalU', '2017-05-23 12:11:21', 'admin'),
(17, 'ingrid.privacy', 'Haftungsausschluss', '2017-05-23 12:11:21', 'admin'),
(18, 'ingrid.contact.intro.postEmail', 'Adresse auf der Kontaktseite', '2017-05-23 12:11:21', 'kst_cg'),
...
(1, 'ingrid_db_version', '3.6.1', '2017-05-23 12:11:21');
...
CREATE TABLE `ingrid_sys_codelist` (
...
CREATE TABLE `ingrid_sys_codelist_domain` (
  `codelist_id` bigint(20) NOT NULL DEFAULT '0',
...
(2, 1, '/webmaster.link', 'webmaster.link', NULL, 'ingrid.page.webmaster.tooltip', 'ingrid.page.webmaster', 0, NULL, 'top', 'mailto:info@informationgrid.eu', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(180, 3, 'org.apache.jetspeed.om.portlet.impl.PortletApplicationDefinitionImpl', 'InGrid-Portal Application', ',,'),
...
(354, 21, 'org.apache.jetspeed.om.portlet.impl.PortletApplicationDefinitionImpl', 'InGrid-Portal Application', ',,');
...
(147, 3, 'org.apache.jetspeed.om.portlet.impl.PortletApplicationDefinitionImpl', 'InGrid-Portal Application', ',,'),
...
(243, 21, 'org.apache.jetspeed.om.portlet.impl.PortletApplicationDefinitionImpl', 'InGrid-Portal Application', ',,');
...
(6, 'org.apache.jetspeed.om.page.impl.PageImpl', 1, '/main-about-partner.psml', NULL, NULL, 'main-about-partner.psml', NULL, 'About InGrid-Portal', 'About InGrid-Portal', 0, 'orange', 'ingrid', 'ingrid-teaser', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
(79, 79, 0, '4'),
(80, 80, 0, 'ingrid.cms.default'),
(81, 81, 0, 'ingrid-home-marginal'),
(82, 82, 0, 'ingrid.teaser.inform'),
(83, 83, 0, '0'),
...
--
-- Indizes für die Tabelle `capability`
--
...
--
-- Indizes für die Tabelle `client_to_capability`
--
ALTER TABLE `client_to_capability`
  ADD PRIMARY KEY (`CLIENT_ID`,`CAPABILITY_ID`);

--
-- Indizes für die Tabelle `client_to_mimetype`
--
ALTER TABLE `client_to_mimetype`
  ADD PRIMARY KEY (`CLIENT_ID`,`MIMETYPE_ID`);
...
--
-- Indizes für die Tabelle `custom_portlet_mode`
--
ALTER TABLE `custom_portlet_mode`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `custom_window_state`
--
ALTER TABLE `custom_window_state`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `event_alias`
--
ALTER TABLE `event_alias`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `event_definition`
--
ALTER TABLE `event_definition`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `filtered_portlet`
--
ALTER TABLE `filtered_portlet`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `filter_lifecycle`
--
ALTER TABLE `filter_lifecycle`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `filter_mapping`
--
ALTER TABLE `filter_mapping`
  ADD PRIMARY KEY (`ID`);
...
ALTER TABLE `folder`
  ...
  ADD UNIQUE KEY `UN_FOLDER_1` (`PATH`),
  ADD KEY `IX_FOLDER_1` (`PARENT_ID`);

--
-- Indizes für die Tabelle `folder_constraint`
--
ALTER TABLE `folder_constraint`
  ADD PRIMARY KEY (`CONSTRAINT_ID`),
  ADD KEY `IX_FOLDER_CONSTRAINT_1` (`FOLDER_ID`);

--
-- Indizes für die Tabelle `folder_constraints_ref`
--
ALTER TABLE `folder_constraints_ref`
  ADD PRIMARY KEY (`CONSTRAINTS_REF_ID`),
  ADD UNIQUE KEY `UN_FOLDER_CONSTRAINTS_REF_1` (`FOLDER_ID`,`NAME`),
  ADD KEY `IX_FOLDER_CONSTRAINTS_REF_1` (`FOLDER_ID`);

--
-- Indizes für die Tabelle `folder_menu`
--
ALTER TABLE `folder_menu`
  ADD PRIMARY KEY (`MENU_ID`),
  ADD KEY `IX_FOLDER_MENU_1` (`PARENT_ID`),
  ADD KEY `IX_FOLDER_MENU_2` (`FOLDER_ID`),
  ADD KEY `UN_FOLDER_MENU_1` (`FOLDER_ID`,`NAME`);

--
-- Indizes für die Tabelle `folder_menu_metadata`
--
ALTER TABLE `folder_menu_metadata`
  ADD PRIMARY KEY (`METADATA_ID`),
  ADD UNIQUE KEY `UN_FOLDER_MENU_METADATA_1` (`MENU_ID`,`NAME`,`LOCALE`,`VALUE`),
  ADD KEY `IX_FOLDER_MENU_METADATA_1` (`MENU_ID`);

--
-- Indizes für die Tabelle `folder_metadata`
--
ALTER TABLE `folder_metadata`
  ADD PRIMARY KEY (`METADATA_ID`),
  ADD UNIQUE KEY `UN_FOLDER_METADATA_1` (`FOLDER_ID`,`NAME`,`LOCALE`,`VALUE`),
  ADD KEY `IX_FOLDER_METADATA_1` (`FOLDER_ID`);

--
-- Indizes für die Tabelle `folder_order`
--
ALTER TABLE `folder_order`
  ADD PRIMARY KEY (`ORDER_ID`),
  ADD UNIQUE KEY `UN_FOLDER_ORDER_1` (`FOLDER_ID`,`NAME`),
  ADD KEY `IX_FOLDER_ORDER_1` (`FOLDER_ID`);
...
ALTER TABLE `fragment`
  ...
  ADD KEY `IX_FRAGMENT_1` (`PARENT_ID`),
  ADD KEY `UN_FRAGMENT_1` (`PAGE_ID`),
  ADD KEY `IX_FRAGMENT_2` (`FRAGMENT_STRING_REFID`),
  ADD KEY `IX_FRAGMENT_3` (`FRAGMENT_STRING_ID`);

--
-- Indizes für die Tabelle `fragment_constraint`
--
ALTER TABLE `fragment_constraint`
  ADD PRIMARY KEY (`CONSTRAINT_ID`),
  ADD KEY `IX_FRAGMENT_CONSTRAINT_1` (`FRAGMENT_ID`);

--
-- Indizes für die Tabelle `fragment_constraints_ref`
--
ALTER TABLE `fragment_constraints_ref`
  ADD PRIMARY KEY (`CONSTRAINTS_REF_ID`),
  ADD UNIQUE KEY `UN_FRAGMENT_CONSTRAINTS_REF_1` (`FRAGMENT_ID`,`NAME`),
  ADD KEY `IX_FRAGMENT_CONSTRAINTS_REF_1` (`FRAGMENT_ID`);

--
-- Indizes für die Tabelle `fragment_pref`
--
ALTER TABLE `fragment_pref`
  ADD PRIMARY KEY (`PREF_ID`),
  ADD UNIQUE KEY `UN_FRAGMENT_PREF_1` (`FRAGMENT_ID`,`NAME`),
  ADD KEY `IX_FRAGMENT_PREF_1` (`FRAGMENT_ID`);

--
-- Indizes für die Tabelle `fragment_pref_value`
--
ALTER TABLE `fragment_pref_value`
  ADD PRIMARY KEY (`PREF_VALUE_ID`),
  ADD KEY `IX_FRAGMENT_PREF_VALUE_1` (`PREF_ID`);

--
-- Indizes für die Tabelle `fragment_prop`
--
ALTER TABLE `fragment_prop`
  ADD PRIMARY KEY (`PROP_ID`),
  ADD UNIQUE KEY `UN_FRAGMENT_PROP_1` (`FRAGMENT_ID`,`NAME`,`SCOPE`,`SCOPE_VALUE`),
  ADD KEY `IX_FRAGMENT_PROP_1` (`FRAGMENT_ID`);

--
-- Indizes für die Tabelle `ingrid_anniversary`
--
ALTER TABLE `ingrid_anniversary`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ingrid_chron_eventtypes`
--
ALTER TABLE `ingrid_chron_eventtypes`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ingrid_cms`
--
ALTER TABLE `ingrid_cms`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ingrid_cms_item`
--
ALTER TABLE `ingrid_cms_item`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ingrid_env_topic`
--
ALTER TABLE `ingrid_env_topic`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ingrid_lookup`
--
ALTER TABLE `ingrid_lookup`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ingrid_measures_rubric`
--
ALTER TABLE `ingrid_measures_rubric`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ingrid_newsletter_data`
--
ALTER TABLE `ingrid_newsletter_data`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ingrid_partner`
--
ALTER TABLE `ingrid_partner`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ingrid_principal_pref`
--
ALTER TABLE `ingrid_principal_pref`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ingrid_provider`
--
ALTER TABLE `ingrid_provider`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ingrid_rss_source`
--
ALTER TABLE `ingrid_rss_source`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ingrid_rss_store`
--
ALTER TABLE `ingrid_rss_store`
  ADD PRIMARY KEY (`link`);

--
-- Indizes für die Tabelle `ingrid_service_rubric`
--
ALTER TABLE `ingrid_service_rubric`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ingrid_sys_codelist`
--
ALTER TABLE `ingrid_sys_codelist`
  ADD PRIMARY KEY (`codelist_id`);

--
-- Indizes für die Tabelle `ingrid_sys_codelist_domain`
--
ALTER TABLE `ingrid_sys_codelist_domain`
  ADD PRIMARY KEY (`codelist_id`,`domain_id`,`lang_id`);

--
-- Indizes für die Tabelle `ingrid_tiny_url`
--
ALTER TABLE `ingrid_tiny_url`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `jetspeed_service`
--
...
ALTER TABLE `link`
  ...
  ADD UNIQUE KEY `UN_LINK_1` (`PATH`),
  ADD KEY `IX_LINK_1` (`PARENT_ID`);

--
-- Indizes für die Tabelle `link_constraint`
--
ALTER TABLE `link_constraint`
  ADD PRIMARY KEY (`CONSTRAINT_ID`),
  ADD KEY `IX_LINK_CONSTRAINT_1` (`LINK_ID`);

--
-- Indizes für die Tabelle `link_constraints_ref`
--
ALTER TABLE `link_constraints_ref`
  ADD PRIMARY KEY (`CONSTRAINTS_REF_ID`),
  ADD UNIQUE KEY `UN_LINK_CONSTRAINTS_REF_1` (`LINK_ID`,`NAME`),
  ADD KEY `IX_LINK_CONSTRAINTS_REF_1` (`LINK_ID`);

--
-- Indizes für die Tabelle `link_metadata`
--
ALTER TABLE `link_metadata`
  ADD PRIMARY KEY (`METADATA_ID`),
  ADD UNIQUE KEY `UN_LINK_METADATA_1` (`LINK_ID`,`NAME`,`LOCALE`,`VALUE`),
  ADD KEY `IX_LINK_METADATA_1` (`LINK_ID`);

--
-- Indizes für die Tabelle `locale_encoding_mapping`
--
ALTER TABLE `locale_encoding_mapping`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `localized_description`
--
ALTER TABLE `localized_description`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `localized_display_name`
--
ALTER TABLE `localized_display_name`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `mediatype_to_capability`
--
ALTER TABLE `mediatype_to_capability`
  ADD PRIMARY KEY (`MEDIATYPE_ID`,`CAPABILITY_ID`);

--
-- Indizes für die Tabelle `mediatype_to_mimetype`
--
ALTER TABLE `mediatype_to_mimetype`
  ADD PRIMARY KEY (`MEDIATYPE_ID`,`MIMETYPE_ID`);
...
--
-- Indizes für die Tabelle `mimetype`
--
ALTER TABLE `mimetype`
  ADD PRIMARY KEY (`MIMETYPE_ID`);

--
-- Indizes für die Tabelle `named_parameter`
--
ALTER TABLE `named_parameter`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `ojb_dlist`
--
ALTER TABLE `ojb_dlist`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `ojb_dlist_entries`
--
ALTER TABLE `ojb_dlist_entries`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `ojb_dmap`
--
ALTER TABLE `ojb_dmap`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `ojb_dset`
--
ALTER TABLE `ojb_dset`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `ojb_dset_entries`
--
ALTER TABLE `ojb_dset_entries`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `ojb_hl_seq`
--
ALTER TABLE `ojb_hl_seq`
  ADD PRIMARY KEY (`TABLENAME`,`FIELDNAME`);

--
-- Indizes für die Tabelle `ojb_lockentry`
--
ALTER TABLE `ojb_lockentry`
  ADD PRIMARY KEY (`OID_`,`TX_ID`);

--
-- Indizes für die Tabelle `ojb_nrm`
--
ALTER TABLE `ojb_nrm`
  ADD PRIMARY KEY (`NAME`);
...
ALTER TABLE `page`
  ...
  ADD UNIQUE KEY `UN_PAGE_1` (`PATH`),
  ADD KEY `IX_PAGE_1` (`PARENT_ID`);

--
-- Indizes für die Tabelle `page_constraint`
--
ALTER TABLE `page_constraint`
  ADD PRIMARY KEY (`CONSTRAINT_ID`),
  ADD KEY `IX_PAGE_CONSTRAINT_1` (`PAGE_ID`);

--
-- Indizes für die Tabelle `page_constraints_ref`
--
ALTER TABLE `page_constraints_ref`
  ADD PRIMARY KEY (`CONSTRAINTS_REF_ID`),
  ADD UNIQUE KEY `UN_PAGE_CONSTRAINTS_REF_1` (`PAGE_ID`,`NAME`),
  ADD KEY `IX_PAGE_CONSTRAINTS_REF_1` (`PAGE_ID`);

--
-- Indizes für die Tabelle `page_menu`
--
ALTER TABLE `page_menu`
  ADD PRIMARY KEY (`MENU_ID`),
  ADD KEY `IX_PAGE_MENU_1` (`PARENT_ID`),
  ADD KEY `IX_PAGE_MENU_2` (`PAGE_ID`),
  ADD KEY `UN_PAGE_MENU_1` (`PAGE_ID`,`NAME`);

--
-- Indizes für die Tabelle `page_menu_metadata`
--
ALTER TABLE `page_menu_metadata`
  ADD PRIMARY KEY (`METADATA_ID`),
  ADD UNIQUE KEY `UN_PAGE_MENU_METADATA_1` (`MENU_ID`,`NAME`,`LOCALE`,`VALUE`),
  ADD KEY `IX_PAGE_MENU_METADATA_1` (`MENU_ID`);

--
-- Indizes für die Tabelle `page_metadata`
--
ALTER TABLE `page_metadata`
  ADD PRIMARY KEY (`METADATA_ID`),
  ADD UNIQUE KEY `UN_PAGE_METADATA_1` (`PAGE_ID`,`NAME`,`LOCALE`,`VALUE`),
  ADD KEY `IX_PAGE_METADATA_1` (`PAGE_ID`);

--
-- Indizes für die Tabelle `page_security`
--
ALTER TABLE `page_security`
  ADD PRIMARY KEY (`PAGE_SECURITY_ID`),
  ADD UNIQUE KEY `UN_PAGE_SECURITY_1` (`PARENT_ID`),
  ADD UNIQUE KEY `UN_PAGE_SECURITY_2` (`PATH`);

--
-- Indizes für die Tabelle `page_sec_constraints_def`
--
ALTER TABLE `page_sec_constraints_def`
  ADD PRIMARY KEY (`CONSTRAINTS_DEF_ID`),
  ADD UNIQUE KEY `UN_PAGE_SEC_CONSTRAINTS_DEF_1` (`PAGE_SECURITY_ID`,`NAME`),
  ADD KEY `IX_PAGE_SEC_CONSTRAINTS_DEF_1` (`PAGE_SECURITY_ID`);

--
-- Indizes für die Tabelle `page_sec_constraints_ref`
--
ALTER TABLE `page_sec_constraints_ref`
  ADD PRIMARY KEY (`CONSTRAINTS_REF_ID`),
  ADD UNIQUE KEY `UN_PAGE_SEC_CONSTRAINTS_REF_1` (`PAGE_SECURITY_ID`,`NAME`),
  ADD KEY `IX_PAGE_SEC_CONSTRAINTS_REF_1` (`PAGE_SECURITY_ID`);

--
-- Indizes für die Tabelle `page_sec_constraint_def`
--
ALTER TABLE `page_sec_constraint_def`
  ADD PRIMARY KEY (`CONSTRAINT_DEF_ID`),
  ADD KEY `IX_PAGE_SEC_CONSTRAINT_DEF_1` (`CONSTRAINTS_DEF_ID`);
...
--
-- Indizes für die Tabelle `parameter_alias`
--
ALTER TABLE `parameter_alias`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `pa_metadata_fields`
--
ALTER TABLE `pa_metadata_fields`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `pa_security_constraint`
--
ALTER TABLE `pa_security_constraint`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `pd_metadata_fields`
--
ALTER TABLE `pd_metadata_fields`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `portlet_application`
--
ALTER TABLE `portlet_application`
  ADD PRIMARY KEY (`APPLICATION_ID`),
  ADD UNIQUE KEY `UK_APPLICATION` (`APP_NAME`);

--
-- Indizes für die Tabelle `portlet_definition`
--
ALTER TABLE `portlet_definition`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `portlet_filter`
--
ALTER TABLE `portlet_filter`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `portlet_listener`
--
ALTER TABLE `portlet_listener`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `portlet_preference`
--
ALTER TABLE `portlet_preference`
  ADD PRIMARY KEY (`ID`),
  ADD UNIQUE KEY `UIX_PORTLET_PREFERENCE` (`DTYPE`,`APPLICATION_NAME`,`PORTLET_NAME`,`ENTITY_ID`,`USER_NAME`,`NAME`);

--
-- Indizes für die Tabelle `portlet_preference_value`
--
ALTER TABLE `portlet_preference_value`
  ADD PRIMARY KEY (`ID`,`PREF_ID`,`IDX`),
  ADD KEY `IX_PORTLET_PREFERENCE` (`PREF_ID`);

--
-- Indizes für die Tabelle `portlet_supports`
--
ALTER TABLE `portlet_supports`
  ADD PRIMARY KEY (`SUPPORTS_ID`),
  ADD UNIQUE KEY `UK_SUPPORTS` (`PORTLET_ID`,`MIME_TYPE`);

--
-- Indizes für die Tabelle `principal_permission`
--
ALTER TABLE `principal_permission`
  ADD PRIMARY KEY (`PRINCIPAL_ID`,`PERMISSION_ID`),
  ADD KEY `IX_PRINCIPAL_PERMISSION_1` (`PERMISSION_ID`),
  ADD KEY `IX_PRINCIPAL_PERMISSION_2` (`PRINCIPAL_ID`);

--
-- Indizes für die Tabelle `principal_rule_assoc`
--
ALTER TABLE `principal_rule_assoc`
  ADD PRIMARY KEY (`PRINCIPAL_NAME`,`LOCATOR_NAME`);

--
-- Indizes für die Tabelle `processing_event`
--
ALTER TABLE `processing_event`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `profile_page_assoc`
--
ALTER TABLE `profile_page_assoc`
  ADD PRIMARY KEY (`LOCATOR_HASH`,`PAGE_ID`);

--
-- Indizes für die Tabelle `profiling_rule`
--
ALTER TABLE `profiling_rule`
  ADD PRIMARY KEY (`RULE_ID`);

--
-- Indizes für die Tabelle `public_parameter`
--
ALTER TABLE `public_parameter`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `publishing_event`
--
ALTER TABLE `publishing_event`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `qrtz_blob_triggers`
--
ALTER TABLE `qrtz_blob_triggers`
  ADD PRIMARY KEY (`TRIGGER_NAME`,`TRIGGER_GROUP`);

--
-- Indizes für die Tabelle `qrtz_calendars`
--
ALTER TABLE `qrtz_calendars`
  ADD PRIMARY KEY (`CALENDAR_NAME`);

--
-- Indizes für die Tabelle `qrtz_cron_triggers`
--
ALTER TABLE `qrtz_cron_triggers`
  ADD PRIMARY KEY (`TRIGGER_NAME`,`TRIGGER_GROUP`);

--
-- Indizes für die Tabelle `qrtz_fired_triggers`
--
ALTER TABLE `qrtz_fired_triggers`
  ADD PRIMARY KEY (`ENTRY_ID`);

--
-- Indizes für die Tabelle `qrtz_job_details`
--
ALTER TABLE `qrtz_job_details`
  ADD PRIMARY KEY (`JOB_NAME`,`JOB_GROUP`);

--
-- Indizes für die Tabelle `qrtz_job_listeners`
--
ALTER TABLE `qrtz_job_listeners`
  ADD PRIMARY KEY (`JOB_NAME`,`JOB_GROUP`,`JOB_LISTENER`);

--
-- Indizes für die Tabelle `qrtz_locks`
--
ALTER TABLE `qrtz_locks`
  ADD PRIMARY KEY (`LOCK_NAME`);

--
-- Indizes für die Tabelle `qrtz_paused_trigger_grps`
--
ALTER TABLE `qrtz_paused_trigger_grps`
  ADD PRIMARY KEY (`TRIGGER_GROUP`);

--
-- Indizes für die Tabelle `qrtz_scheduler_state`
--
ALTER TABLE `qrtz_scheduler_state`
  ADD PRIMARY KEY (`INSTANCE_NAME`);

--
-- Indizes für die Tabelle `qrtz_simple_triggers`
--
ALTER TABLE `qrtz_simple_triggers`
  ADD PRIMARY KEY (`TRIGGER_NAME`,`TRIGGER_GROUP`);

--
-- Indizes für die Tabelle `qrtz_triggers`
--
ALTER TABLE `qrtz_triggers`
  ADD PRIMARY KEY (`TRIGGER_NAME`,`TRIGGER_GROUP`),
  ADD KEY `JOB_NAME` (`JOB_NAME`,`JOB_GROUP`);

--
-- Indizes für die Tabelle `qrtz_trigger_listeners`
--
ALTER TABLE `qrtz_trigger_listeners`
  ADD PRIMARY KEY (`TRIGGER_NAME`,`TRIGGER_GROUP`,`TRIGGER_LISTENER`);

--
-- Indizes für die Tabelle `rule_criterion`
--
ALTER TABLE `rule_criterion`
  ADD PRIMARY KEY (`CRITERION_ID`),
  ADD KEY `IX_RULE_CRITERION_1` (`RULE_ID`),
  ADD KEY `IX_RULE_CRITERION_2` (`RULE_ID`,`FALLBACK_ORDER`);

--
-- Indizes für die Tabelle `runtime_option`
--
ALTER TABLE `runtime_option`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `runtime_value`
--
ALTER TABLE `runtime_value`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `secured_portlet`
--
ALTER TABLE `secured_portlet`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `security_attribute`
--
ALTER TABLE `security_attribute`
  ADD PRIMARY KEY (`ATTR_ID`,`PRINCIPAL_ID`,`ATTR_NAME`),
  ADD KEY `IX_NAME_LOOKUP` (`ATTR_NAME`),
  ADD KEY `IX_PRINCIPAL_ATTR` (`PRINCIPAL_ID`);

--
-- Indizes für die Tabelle `security_credential`
--
ALTER TABLE `security_credential`
  ADD PRIMARY KEY (`CREDENTIAL_ID`),
  ADD KEY `IX_SECURITY_CREDENTIAL_1` (`PRINCIPAL_ID`);

--
-- Indizes für die Tabelle `security_domain`
--
ALTER TABLE `security_domain`
  ADD PRIMARY KEY (`DOMAIN_ID`),
  ADD UNIQUE KEY `UIX_DOMAIN_NAME` (`DOMAIN_NAME`);

--
-- Indizes für die Tabelle `security_permission`
--
ALTER TABLE `security_permission`
  ADD PRIMARY KEY (`PERMISSION_ID`),
  ADD UNIQUE KEY `UIX_SECURITY_PERMISSION` (`PERMISSION_TYPE`,`NAME`,`ACTIONS`);

--
-- Indizes für die Tabelle `security_principal`
--
ALTER TABLE `security_principal`
  ADD PRIMARY KEY (`PRINCIPAL_ID`),
  ADD UNIQUE KEY `UIX_SECURITY_PRINCIPAL` (`PRINCIPAL_TYPE`,`PRINCIPAL_NAME`,`DOMAIN_ID`),
  ADD KEY `IX_SECURITY_DOMAIN_1` (`DOMAIN_ID`);

--
-- Indizes für die Tabelle `security_principal_assoc`
--
ALTER TABLE `security_principal_assoc`
  ADD PRIMARY KEY (`ASSOC_NAME`,`FROM_PRINCIPAL_ID`,`TO_PRINCIPAL_ID`),
  ADD KEY `IX_TO_PRINCIPAL_ASSOC_LOOKUP` (`ASSOC_NAME`,`TO_PRINCIPAL_ID`),
  ADD KEY `IX_FROM_PRINCIPAL_ASSOC` (`FROM_PRINCIPAL_ID`),
  ADD KEY `IX_TO_PRINCIPAL_ASSOC` (`TO_PRINCIPAL_ID`);

--
-- Indizes für die Tabelle `security_role`
--
ALTER TABLE `security_role`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `security_role_reference`
--
ALTER TABLE `security_role_reference`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `sso_site`
--
ALTER TABLE `sso_site`
  ADD PRIMARY KEY (`SITE_ID`),
  ADD UNIQUE KEY `UIX_SITE_NAME` (`NAME`),
  ADD UNIQUE KEY `UIX_SITE_URL` (`URL`),
  ADD KEY `IX_SECURITY_DOMAIN_2` (`DOMAIN_ID`);

--
-- Indizes für die Tabelle `user_attribute`
--
ALTER TABLE `user_attribute`
  ADD PRIMARY KEY (`ID`);

--
-- Indizes für die Tabelle `user_attribute_ref`
--
...
--
-- AUTO_INCREMENT für Tabelle `ingrid_anniversary`
--
ALTER TABLE `ingrid_anniversary`
  MODIFY `id` mediumint(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18115;

--
-- AUTO_INCREMENT für Tabelle `ingrid_chron_eventtypes`
--
ALTER TABLE `ingrid_chron_eventtypes`
  MODIFY `id` mediumint(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT für Tabelle `ingrid_cms`
--
ALTER TABLE `ingrid_cms`
  MODIFY `id` mediumint(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT für Tabelle `ingrid_cms_item`
--
ALTER TABLE `ingrid_cms_item`
  MODIFY `id` mediumint(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

--
-- AUTO_INCREMENT für Tabelle `ingrid_env_topic`
--
ALTER TABLE `ingrid_env_topic`
  MODIFY `id` mediumint(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT für Tabelle `ingrid_measures_rubric`
--
ALTER TABLE `ingrid_measures_rubric`
  MODIFY `id` mediumint(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT für Tabelle `ingrid_newsletter_data`
--
ALTER TABLE `ingrid_newsletter_data`
  MODIFY `id` mediumint(9) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ingrid_partner`
--
ALTER TABLE `ingrid_partner`
  MODIFY `id` mediumint(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT für Tabelle `ingrid_principal_pref`
--
ALTER TABLE `ingrid_principal_pref`
  MODIFY `id` mediumint(9) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ingrid_provider`
--
ALTER TABLE `ingrid_provider`
  MODIFY `id` mediumint(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=563;

--
-- AUTO_INCREMENT für Tabelle `ingrid_rss_source`
--
ALTER TABLE `ingrid_rss_source`
  MODIFY `id` mediumint(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;

--
-- AUTO_INCREMENT für Tabelle `ingrid_service_rubric`
--
ALTER TABLE `ingrid_service_rubric`
  MODIFY `id` mediumint(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT für Tabelle `ingrid_tiny_url`
--
ALTER TABLE `ingrid_tiny_url`
