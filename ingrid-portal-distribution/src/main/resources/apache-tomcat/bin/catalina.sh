...
export CATALINA_PID=$INGRID_HOME/catalina.pid
...
# INGRID: include default options, i.e. debug, jmx and jvm options
...
JAVA_OPTS="$JAVA_OPTS $INGRID_OPTS -Dorg.apache.jasper.compiler.Parser.STRICT_QUOTE_ESCAPING=false -Duser.language=de --add-opens=java.xml/com.sun.org.apache.xml.internal.dtm.ref=ALL-UNNAMED --add-opens=java.base/java.lang=ALL-UNNAMED"
