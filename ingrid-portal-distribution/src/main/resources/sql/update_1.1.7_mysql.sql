-- change ingrid permissions actions to '*'
UPDATE security_permission SET ACTIONS = '*' WHERE CLASSNAME='de.ingrid.portal.security.permission.IngridPortalPermission';
...
INSERT INTO ingrid_temp (VALUE) VALUES ((SELECT FRAGMENT_ID FROM fragment WHERE PAGE_ID=(SELECT PAGE_ID FROM page WHERE NAME='dwr-test.psml')));

DELETE FROM fragment WHERE PARENT_ID=(SELECT value FROM ingrid_temp);
