...
(SELECT FRAGMENT_ID FROM fragment WHERE PAGE_ID=(SELECT PAGE_ID FROM page WHERE NAME='mdek_portal_admin.psml')),
...
UPDATE fragment SET PARENT_ID = (SELECT PAGE_ID FROM page WHERE NAME='mdek_portal_admin.psml'),
