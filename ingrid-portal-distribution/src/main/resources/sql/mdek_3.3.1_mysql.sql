...
(1373, 0, 6010, -1, 'en', 'Open Data', 'This checkbox defines this object as an "open data"-object. When activated, the appearing table "Categories" must contain at least one value before the object can be published.', ''),
(1374, 0, 6020, -1, 'de', 'Kategorien', 'Die Kategorien enthalten eine Auswahl, die das Open Data - Objekt näher bestimmen.', ''),
(1375, 0, 6020, -1, 'en', 'Categories', 'The categories contain a choice, which are used to describe the open data object more detailed', '');