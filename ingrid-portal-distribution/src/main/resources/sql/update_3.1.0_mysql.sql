-- DB Version erhöhen
UPDATE ingrid_lookup SET `item_value` = '3.1.0', `item_date` = NOW() WHERE `ingrid_lookup`.`item_key` ='ingrid_db_version' LIMIT 1 ;

-- reorder main menu
UPDATE folder_menu SET `ELEMENT_ORDER` = '1' WHERE OPTIONS ="/main-environment.psml" LIMIT 1 ;
UPDATE folder_menu SET `ELEMENT_ORDER` = '3' WHERE OPTIONS ="/main-service.psml" LIMIT 1 ;
UPDATE folder_menu SET `ELEMENT_ORDER` = '5' WHERE OPTIONS ="/main-maps.psml" LIMIT 1 ;
UPDATE folder_menu SET `ELEMENT_ORDER` = '6' WHERE OPTIONS ="/main-chronicle.psml" LIMIT 1 ;
UPDATE folder_menu SET `ELEMENT_ORDER` = '7', OPTIONS = '/main-features.psml' WHERE OPTIONS ="/main-about.psml" LIMIT 1 ;
UPDATE folder_menu SET `ELEMENT_ORDER` = '8' WHERE OPTIONS ="/administration" LIMIT 1 ;
UPDATE folder_menu SET `ELEMENT_ORDER` = '9' WHERE OPTIONS ="/Administrative" LIMIT 1 ;

-- move catalog menu to main menu
UPDATE folder_menu SET `PARENT_ID` = '19', `ELEMENT_ORDER` = '4' WHERE `folder_menu`.`OPTIONS` ="/search-catalog/search-catalog-hierarchy.psml" LIMIT 1 ;
...
UPDATE page SET `TITLE` = 'ingrid.page.search.catalog.tooltip' WHERE  `page`.`PATH` ="/search-catalog/search-catalog-hierarchy.psml" LIMIT 1 ;
UPDATE page SET `TITLE` = 'ingrid.page.search.tooltip' WHERE          `page`.`PATH` ="/main-search.psml" LIMIT 1 ;
UPDATE page SET `TITLE` = 'ingrid.page.service.tooltip' WHERE         `page`.`PATH` ="/main-service.psml" LIMIT 1 ;
UPDATE page SET `TITLE` = 'ingrid.page.measures.tooltip' WHERE        `page`.`PATH` ="/main-measures.psml" LIMIT 1 ;
UPDATE page SET `TITLE` = 'ingrid.page.envtopics.tooltip' WHERE       `page`.`PATH` ="/main-environment.psml" LIMIT 1 ;
UPDATE page SET `TITLE` = 'ingrid.page.maps.tooltip' WHERE            `page`.`PATH` ="/main-maps.psml" LIMIT 1 ;
UPDATE page SET `TITLE` = 'ingrid.page.chronicle.tooltip' WHERE       `page`.`PATH` ="/main-chronicle.psml" LIMIT 1 ;
UPDATE page SET `TITLE` = 'ingrid.page.about.tooltip' WHERE           `page`.`PATH` ="/main-about.psml" LIMIT 1 ;

UPDATE page SET `TITLE` = 'ingrid.page.home.tooltip' WHERE            `page`.`PATH` ="/default-page.psml" LIMIT 1 ;
UPDATE page SET `TITLE` = 'ingrid.page.myportal.tooltip' WHERE        `page`.`PATH` ="/service-myportal.psml" LIMIT 1 ;
UPDATE page SET `TITLE` = 'ingrid.page.sitemap.tooltip' WHERE         `page`.`PATH` ="/service-sitemap.psml" LIMIT 1 ;
UPDATE page SET `TITLE` = 'ingrid.page.help.link.tooltip' WHERE       `page`.`PATH` ="/help.psml" LIMIT 1 ;
UPDATE page SET `TITLE` = 'ingrid.page.contact.tooltip' WHERE         `page`.`PATH` ="/service-contact.psml" LIMIT 1 ;
UPDATE page SET `TITLE` = 'ingrid.page.disclaimer.tooltip' WHERE      `page`.`PATH` ="/disclaimer.psml" LIMIT 1 ;
UPDATE page SET `TITLE` = 'ingrid.page.privacy.tooltip' WHERE         `page`.`PATH` ="/privacy.psml" LIMIT 1 ;

UPDATE page SET `TITLE` = 'ingrid.page.newsletter.tooltip',`SHORT_TITLE` = 'ingrid.page.newsletter' WHERE `page`.`PATH` ="/service-contact-newsletter.psml" LIMIT 1;

UPDATE link SET `TITLE` = 'ingrid.page.webmaster.tooltip' WHERE       `link`.`PATH` ="/webmaster.link" LIMIT 1 ;
...
INSERT INTO ingrid_lookup (`item_key`, `item_value`) values ('fragment_tmp_id', '0');
