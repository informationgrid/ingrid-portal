    ...
    return declare(null, {
        ...
        createFields: function () {
            ...
            var geometryContextStructure = [
                {
                    field: 'geometryType',
                    name: message.get("upsh.form.geometryContext.geometryType") + "*",
                    width: '100px',
                    editable: true
                },
                {field: 'name', name: message.get("upsh.form.geometryContext.name") + "*", width: '100px', editable: true},
                {
                    field: 'featureType',
                    name: message.get("upsh.form.geometryContext.featureType") + "*",
                    width: '100px',
                    editable: true,
                ...
                {
                    field: 'dataType',
                    name: message.get("upsh.form.geometryContext.dataType") + "*",
                    width: '130px',
                    editable: true
                },
                {
                    field: 'description',
                    name: message.get("upsh.form.geometryContext.description") + "*",
                    width: 'auto',
                    editable: true
                },
            ...
            var table = layoutCreator.createDomDataGrid({
                id: id,
                name: message.get("upsh.form.geometryContext"),
                help: message.get("upsh.form.geometryContext.help"),
            ...
            construct.create("a", {
                innerHTML: message.get("upsh.form.button.addGeometryContext"),
                style: {
                    cursor: "pointer"
                },
                onclick: lang.hitch(this, function () {
                    dialog.showPage(message.get("upsh.dialog.geometryContext.nominal"), "dialogs/mdek_up-sh_geometryContext_dialog.jsp", 800, 300, true, {
        ...
        createNokisContextMenus: function () {
            ...
            contextMenu.addChild(new MenuItem({
                ...
                label: message.get('upsh.contextmenu.geometryContext'),
                onClick: function () {
                    ...
                    dialog.showPage(message.get("upsh.dialog.geometryContext.nominal"), 'dialogs/mdek_up-sh_geometryContext_dialog.jsp?c=' + userLocale, 800, 300, true, dialogData);
                }
            }));
        },
