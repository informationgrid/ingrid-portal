...
<body>
    <div class="container">
        <div class="header-menu"
            style="display: none; overflow: hidden; outline: none; cursor: grab; touch-action: none;"
            role="navigation" aria-label="Navigation Menu">
            <div class="header-menu-close">
                <button type="button" class="button ">
                    Menu<span class="ic-ic-cross"></span>
                </button>
            </div>
            <div class="menu-main-links">
                <a href="/kontakt"
                    title="Ihre Nachricht, Fragen oder Anregungen direkt an BKG-MIS"><span
                    class="text">Kontakt</span></a> <a href="/impressum"
                    title="Inhaltlich und technisch Verantwortliche, Nutzungsbedingungen, Haftungsausschluss"><span
                    class="text">Impressum</span></a> <a href="https://www.bkg.bund.de/DE/Service/Datenschutz/datenschutz.html"
                    title="Unsere Verpflichtung zum Umgang mit persönlichen Informationen"><span
                    class="text" target="_blank">Datenschutz</span></a> <a href="/barrierefreiheit"
                    title="Erklärung zur Barrierefreiheit"><span class="text">Erklärung zur Barrierefreiheit</span></a>
            </div>
                    ...
                    <div class="row">
                      ...
                      <div class="columns xsmall-4 small-7 medium-7 large-7 xlarge-13">
                        <div class="desktop__title">
                            <a href="http://bkg-test.informationgrid.eu:80/startseite" title="Startseite von BKG-MIS aufrufen ">
                                <span>
