        ...
        require(["dojo/_base/lang",
            ...
            function init() {
                ...
                var attributesStructure = [
                    {field: 'key', name: message.get("nokis.attributes.code"), width: '200px', editable: true},
                    {field: 'value', name: message.get("nokis.attributes.definition"), width: 'auto', editable: true}
                ];
