    ...
    return declare(null, {
        ...
        interceptHelpMessages: function() {
            var interceptedGuiIds = {
                ...
                1410: { helpText: message.get("help.mcloud.form.freeKeywords.text"), name: message.get("help.mcloud.form.freeKeywords.title"), sample: message.get("help.mcloud.form.freeKeywords.example") },
                1420: { helpText: message.get("help.mcloud.form.optionalKeywords.text"), name: message.get("help.mcloud.form.optionalKeywords.title"), sample: message.get("help.mcloud.form.optionalKeywords.example") },
