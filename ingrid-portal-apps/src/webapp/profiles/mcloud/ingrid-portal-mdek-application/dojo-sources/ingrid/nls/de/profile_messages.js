...
define({
    ...
    "help.mcloud.form.timeSection.text": "Angabe des Zeitraums oder des Zeitpunktes, für den der Datensatz Gültigkeit hat. In der mCLOUD erscheint dieser Eintrag in der Detailansicht unter „Aktualität der Daten“.<br /><br />Die Einträge in die folgenden Felder sind optional.",
    "help.mcloud.form.resourceDate.title": "Zeitbezug der Ressource",
    "help.mcloud.form.resourceDate.text": "Angabe, wann der Datensatz erstellt, zuletzt revidiert und/oder publiziert wurde.",
    ...
    "help.mcloud.form.timeCoverage.text": "Hier soll die Zeitspanne der Entstehung der eigentlichen Daten (z.B. Messdaten) eingetragen werden. Dies ist nur dann sinnvoll, wenn der Datenbestand sich nicht auf einen einzelnen Zeitpunkt bezieht, sondern auf einen längeren Zeitraum.",
