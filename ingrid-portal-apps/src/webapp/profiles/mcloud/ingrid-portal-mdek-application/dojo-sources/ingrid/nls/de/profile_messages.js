...
define({
    ...
    "help.mcloud.form.optionalKeywords.text": "Optionale Eingabe von Schlagworten. Die Verschlagwortung dient dem themenbezogenen Wiederauffinden (Retrieval) der Objekte. Die Schlagworte sollen das Objekt so genau wie möglich, aber auch so allgemein wie nötig beschreiben. Die Auswahl kann auch über den \"Verschlagwortungsassistenten\" vorgenommen werden. Dieser analysiert den Inhalt des Objekts und schlägt Schlagworte vor. Alternativ können Schlagworte in jeder Zeile frei eingegeben werden.<br /><br />In der mCLOUD erscheinen die Schlagworte unterhalb der Beschreibung.",
    "help.mcloud.form.optionalKeywords.example": "Straßenverkehr; Kartierung; Deutschland",
    ...
    "help.mcloud.form.address.institution.text": "Name der Institution. Hier soll die vollständige, offizielle Bezeichnung der Institution eingetragen werden.<br /><br />Der Eintrag in dieses Feld ist obligatorisch.<br /><br />ACHTUNG:<br />Verändern Sie bei einer bereits veröffentlichten Adresse die Institution, so wird diese Änderung nicht sofort in die mCLOUD übertragen. Die Änderung ist erst am nächsten Tag in der mCLOUD sichtbar. Erst nachts wird der gesamte Katalog neu indexiert und damit die neue Adresse in alle betroffenen Datensätze übernommen.",
    "help.mcloud.form.address.communication.title": "Kommunikation",
    "help.mcloud.form.address.communication.text": "Angabe von Telefonnummern, Faxnummer, E-Mail, URL-Adresse usw. In dieser Tabelle sollen alle Kommunikationsmittel (außer normaler Post) eingetragen werden, mit denen die Institution erreicht werden kann. Die Bezeichnung kann über eine Auswahlliste eingegeben werden. In der rechten Spalte wird die zugehörige Nummer für Telefon oder Fax bzw. Adresse für E-Mail-Kommunikation eingegeben.<br />Wichtig: Die Angabe der E-Mail Adresse ist Pflicht! (INSPIRE-Pflichtfeld)<br /><br />Die hier angegebene URL wird auch in der mCLOUD als Link für die Institution verwendet. Bei fehlender URL wird in der mCLOUD die Institution ohne Link dargestellt.<br /><br />ACHTUNG:<br />Verändern Sie bei einer bereits veröffentlichten Adresse die URL, so wird diese Änderung nicht sofort in die mCLOUD übertragen. Die Änderung ist erst am nächsten Tag in der mCLOUD sichtbar. Erst nachts wird der gesamte Katalog neu indexiert und damit die neue URL in alle betroffenen Datensätze übernommen.",
    "help.mcloud.form.address.street.title": "Straße/Hausnummer",
    "help.mcloud.form.address.street.text": "Angabe der Hausadresse. Bei der Straße und Hausnummer der Institution sollte es sich um die Adresse der Zentrale bzw. des Hauptgebäudes handeln.",
    "help.mcloud.form.address.city.title": "Ort",
    "help.mcloud.form.address.city.text": "Es ist der Ort anzugeben, wo sich die Zentrale bzw. das Hauptgebäude der Institution befindet. Für den Fall, dass der Ort für Hausadresse (Straße/Hausnummer) und Postadresse (Postfach) verschieden ist, kann nur eine vollständige Adresse eingetragen werden (Haus- oder Postadresse).",
    ...
    "mcloud.form.downloads.helpMessage": "In diese Felder werden die Links auf die eigentlichen Daten eingetragen. Für jeden Link sind vier Felder auszufüllen:<br /><ul><li>Titel: Ein kurzer für den verlinkten Datensatz spezifischer Titel.<br />Beispiel: 'Reisezentrenliste der DB Vertrieb GmbH (Stand: 19.07.2018)'</li><li>Link: Der Link auf die Datenquelle. Zum Eintragen eines Links s.u.</li><li>Typ: Angabe, um welche Art des Datenzugangs es sich handelt (z.B. Download, FTP, WMS, AtomFeed, etc.).</li><li>Datenformat: Dateiformat, in dem die Daten vorliegen. Hier ist auch eine freie Eingabe möglich.</li></ul>Eintragen eines Links:<br />Ein Link kann nur über Klick auf 'Hinzufügen' und 'Link angeben' eingetragen werden und nicht direkt in der Zeile. Da Links auch hoch geladene Dokumente repräsentieren können, wird dies in einem einheitlichen Dialog gesteuert. Aus diesem Grund ist in der Zeile ein einmal eingegebener Link auch nicht änderbar. Stattdessen muss ein neuer Eintrag mit neuem Link angelegt werden.<br /><br />Upload von Dokumenten:<br />Hoch geladene Dokumente werden unter der UUID des Metadatensatzes abgelegt.<br /><br />Die Einträge in dieses Feld sind obligatorisch (Link, Typ).",
    "mcloud.form.downloads.uploadQuota.info": "<br>Die Uploads sind beschränkt auf maximal <b>1 GB pro Datei</b> und maximal <b>5 GB pro Metadatensatz</b>.",
    "mcloud.form.downloads.delete.info": "Folgende Uploads werden automatisch vom Server gelöscht (innerhalb der nä. 24 h)!",
