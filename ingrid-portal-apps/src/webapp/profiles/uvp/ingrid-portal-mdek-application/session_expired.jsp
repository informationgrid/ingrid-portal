...
<html xmlns="http://www.w3.org/1999/xhtml" lang="de">
    <head>
        ...
        <meta name="description" content="Das UVP-Portal der Bundesl&auml;nder bietet Zugang zu Umweltvertr&auml;glichkeitspr&uuml;fungen von Verfahrensf&uuml;hrenden Stellen auf L&auml;nderebene." />
        <meta name="author" content="wemove digital solutions" />
        <meta name="keywords" lang="de" content="UVP, Umweltvertr&auml;glichkeitspr&uuml;fung, Genehmigungsverfahren, Vorhaben, Zulassungsverfahren, Raumordnungsverfahren, Negative Vorpr&uuml;fungen, Ausl&auml;ndische Vorhaben, Vorhabenbeschreibung, Bekanntmachung, Er&ouml;rterungstermin, &ouml;ffentliche Auslegung, Auslegungsinformation, Verfahrensst&auml;nde, Termine, Antragsunterlagen, UVP-Bericht, Unterlagen, Berichte, Empfehlungen, Entscheidungen, Ergebnis, Zulassung, Bauleitplanung, Ansprechpartner, Verfahrensf&uuml;hrende Beh&ouml;rden, Umweltinformationen, Umwelt, Deutschland, Bundesl&auml;nder" />
                    ...
                    <div class="columns small-7 medium-9 large-7 xlarge-6">
                        <div class="logo">
                            <a href="/startseite" class="hide-for-medium hide-for-xsmall-only">
                                <img src="/decorations/layout/ingrid/images/template/logo.svg" alt="UVP"/>
                            </a>
                            <a href="/startseite" class="show-for-medium hide-for-xsmall-only">
                                <img src="/decorations/layout/ingrid/images/template/logo-mit-tag.svg" alt="UVP"/>
                            </a>
                            <a href="/startseite" class="show-for-xsmall-only">
                                <img src="/decorations/layout/ingrid/images/template/logo-xsmall.svg" alt="UVP"/>
                            </a>
                        </div>
                    </div>
