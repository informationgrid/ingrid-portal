    ...
    "ingrid/utils/Catalog"
        ...
        */
        ...
        function renderNodeData(nodeData) {
            ...
            renderTextWithTitle(UtilSyslist.getSyslistEntryName(UtilSyslist.listIdObjectClass, nodeData.objectClass), "<fmt:message key='ui.obj.header.objectClass' />");
...
*/
        ...
        function renderAdditionalFieldsForRubric(rubric, nodeData, isDynamic) {
        ...
        function renderAdditionalRubrics(additionalFields) {
            ...
            array.forEach(addDomRubrics, function(domRubric) {
                ...
                if (domRubric.classList.contains("phase")) {
                    ...
                    var fields = [];
                    // normalize array
                    array.forEach(phase.tableRows, function(row) {
                        fields.push(row[0]);
                    });
                    
                    renderAdditionalFieldsForRubric(domRubric.id, fields, true);
