...
-- Show '/privacy.psml'
UPDATE page SET is_hidden = 0 WHERE path = '/privacy.psml';
...
INSERT INTO tmp_table (item_key, item_value) values ('main_menu_id',  (SELECT menu_id FROM folder_menu WHERE name = 'main-menu')); 
...
UPDATE folder_menu SET element_order = 3 WHERE parent_id = (SELECT item_value FROM tmp_table WHERE item_key = 'main_menu_id') AND options = '/search-catalog/search-catalog-hierarchy.psml';
UPDATE folder_menu SET element_order = 2 WHERE parent_id = (SELECT item_value FROM tmp_table WHERE item_key = 'main_menu_id') AND options = '/main-measures.psml';
UPDATE folder_menu SET element_order = 1 WHERE parent_id = (SELECT item_value FROM tmp_table WHERE item_key = 'main_menu_id') AND options = '/main-maps.psml';
