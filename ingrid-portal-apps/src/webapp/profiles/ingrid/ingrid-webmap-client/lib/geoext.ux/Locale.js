...
Local = {
    ...
    localizedStrings: {
    	...
    	tFuerTransparenzErst : { en: 'Select a layer for transparency first.', de: 'F&uuml;r Sichtbarkeitsfunktion einen Layer markieren.' },
        ...
        tHintZoomToView : { en: '<p class="hint">You may have to zoom into the map to see the layers of the external service. The provider of the service is responsible for the display of the service. InGrid has no influence here.</p>', de: '<p class="hint">Nutzen Sie zur Darstellung einzelner Layer die Zoom-Funktion. F&uuml;r die Inhalte des Dienstes ist der jeweilige Betreiber verantwortlich.</p>' },
        ...
        tLayerTransparenz : { en: 'Layer transparency', de: 'Layer Sichtbarkeit' },
        ...
        tTipsAndTricks: { en: 'Tips', de: 'Tipps' },
        ...
        tWelcomeTextTransparency: { en: 'Apply layer <strong>transparency</strong> using the slider control', de: 'Steuert die Layer-Sichtbarkeit &uuml;ber einen Schieberegler (Rubrik: Aktive Dienste)'},
        ...
        tWelcomeTextMeassure: { en: 'Measure distance or area on the map', de: 'Misst Strecken oder Fl&auml;chen auf der Karte'},
        
        tWelcomeTextPrint: { en: 'Print the current map to PDF', de: 'Druckt den aktuellen Kartenausschnitt als PDF'},
        tWelcomeTextLoad: { en: 'Open an existing map (Access to this feature requires a personal account)', de: 'L&auml;dt die zuvor gespeicherte Karten (<strong>Mein InGrid</strong> Login erforderlich)'},
        tWelcomeTextSave: { en: 'Saves the current map (Access to this feature requires a personal account)', de: 'Speichert die aktuelle Kartenansicht (<strong>Mein InGrid</strong> Login erforderlich)'},
        ...
        tWelcomeTextTipp2: { en: '<h1>You want to visualize your own or external data in our map viewer?</h1><p>All you need is a valid GetCapabilities URL. Our map client supports WMS 1.1.0, 1.1.1 and 1.3.0. Add the GetCapabilities URL by using the plus symbol <span class="iconTable iconAdd" style="display: inline-block;"></span> from the toolbar.</p>', de: '<h1>Sie wollen eigene Kartendienste in unserem Kartenviewer visualisieren?</h1><p>Externe Kartendienste lassen sich &uuml;ber GetCapabilities-URLs einbinden. Unterst&uuml;tzt werden die Standards 1.1.0, 1.1.1 und 1.3.0. Klicken Sie auf die Rubrik <b>Externer Dienst</b> und geben Sie eine entsprechende URL ein.</p>'},
        tWelcomeTextTipp3: { en: '<h1>You have added a digital map, but you can’t see any data?</h1><p>Some layers are only displayed at certain scales. The layers are displayed, when the scale of the current map view and the layer scale match. Otherwise the names of the layers are greyed out (flag active services) and the data are not drawn. You can make the data visible by zooming into the map or by using the feature Zoom-To-Layer <span class="iconTable iconZoomLayerExtent" style="display: inline-block;"></span>.</p>', de: '<h1>Obwohl Sie einen Kartendienst geladen haben, werden die Layer nicht in der Karte dargestellt?</h1><p>Die Informationen mancher Layer werden nur innerhalb eines bestimmten Ma&szlig;stabbereichs dargestellt. Au&szlig;erhalb des Ma&szlig;stabsbereichs wird der entsprechende Layer-Titel ausgegraut. &Auml;ndern Sie den Ma&szlig;stab mithilfe des <i>Navigation-Tools</i> im Kartenfenster oder unter <b>Einstellungen</b>.</p>'},
        tWelcomeTextTipp4: { en: '<h1>You are searching maps on a particular topic?</h1><p>Use the search field below the list of topics to find further maps. By entering a keyword, all connected catalogues from our partners will be searched for suitable maps (WMS).</p>', de: '<h1>Sie suchen Karten zu einem bestimmten Umweltthema?</h1><p>Finden Sie eine passende Karte in der Rubrik <b>Suche</b>. Mit der Suchanfrage werden s&auml;mtliche angeschlossene Kataloge aus Bund und L&auml;ndern nach passenden Kartendiensten durchsucht.</p>'},
        tWelcomeTextTipp5: { en: '<h1>You want to save the current map and load it at a later stage?</h1><p>Take advantage of a personal InGrid Login: Register on <a href="/personalisierungsoptionen"><strong>my InGrid</strong></a> and make use of various options to personalize InGrid.</p>', de: '<h1>Sie wollen eine Kartenansicht speichern und zu einem sp&auml;teren Zeitpunkt wieder aufrufen?</h1><p>Nutzen Sie die Vorteile eines pers&ouml;nlichen InGrid Logins: Unter <a href="/personalisierungsoptionen"><strong>Mein InGrid</strong></a> k&ouml;nnen Sie sich als Benutzer registrieren. Damit steht Ihnen eine Vielzahl von M&ouml;glichkeiten offen, die Funktionen des Portals nach Ihren Bed&uuml;rfnissen zusammenzustellen.</p>'},
        tWelcomeTextTitle: { en: 'WELCOME TO THE MAP VIEWER', de: 'WILLKOMMEN BEIM KARTENVIEWER'},
        tWelcomeTextSubtitle: { en: 'Our map viewer contains a selection of digital maps (WMS) from public organisations in Germany. More than 200 digital maps are ordered by provider and by topic. Beyond that you can use the search function to find further maps.<br/>The base map (web map service WebAtlasDE.light, &#169; GeoBasis-DE / BKG) is provided by the Federal Agency for Cartography and Geodesy (BKG).', de: 'Im InGrid-Kartenviewer werden eine Vielzahl verschiedener Kartendienste von Umweltbeh&ouml;rden aus Bund und L&auml;ndern bereitgestellt.<br/>Die Hintergrundkarte (Kartendienst WebAtlasDE.light, &#169; GeoBasis-DE / BKG) wird durch das Bundesamt f&uuml;r Kartographie und Geod&auml;sie (BKG) bereitgestellt.'},
		...
		tTransparenz: {en: 'Transparency', de: 'Sichtbarkeit'},
		tInformation: {en: 'Information', de: 'Information'},
		tNoInformationAvailable: {en: 'No information available.', de: 'Keine Informationen vorhanden.'},
		tLoeschen: {en: 'Delete', de: 'L&ouml;schen'},
		...
		tPortal: {en: 'Open InGrid', de: 'InGrid &ouml;ffnen'},
		...
		tPositionWGS: {en: 'L&auml;nge / Breite', de: 'L&auml;nge / Breite'},
