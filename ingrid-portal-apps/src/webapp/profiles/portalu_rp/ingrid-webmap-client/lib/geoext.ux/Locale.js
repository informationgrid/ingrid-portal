...
Local = {
    ...
    localizedStrings: {
        ...
        tSuchbegriffEingeben : { en: '<p>Enter search query</p>', de: '<p><b>Suchraum:</b> <br>Neben den unter "Themen" und "Anbieter" eingebundenen Kartendiensten werden auch Angaben zu Kartendiensten aus Umweltdatenkatalogen bei der Suche berücksichtigt.</p>' },
        ...
        tWelcomeTextLoad: { en: 'Open an existing map (Access to this feature requires a personal account)', de: 'L&auml;dt die zuvor gespeicherte Karten (<strong>Mein Portal</strong> Login erforderlich)'},
        tWelcomeTextSave: { en: 'Saves the current map (Access to this feature requires a personal account)', de: 'Speichert die aktuelle Kartenansicht (<strong>Mein Portal</strong> Login erforderlich)'},
