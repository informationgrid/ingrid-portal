...
<html xmlns="http://www.w3.org/1999/xhtml" lang="de">
    <head>
        <title>PortalU - Umweltportal Rheinland-Pfalz</title>
            ...
            <div class="header-menu" style="display: none; overflow: hidden; outline: none;" tabindex="1">
                ...
                <div class="menu-main-links">
                    <div class="highlighted">
                        ...
                        <a href="/datenkataloge" class="header-menu-entry " title="Themen"><span class="text">Themen</span></a>
                        <a href="/hintergrundinformationen" class="header-menu-entry " title="Hintergrundinformationen zu PortalU"><span class="text">Über PortalU</span></a>
                    ...
                    <a href="/log-in"><span class="text">Intern</span></a>
                </div>
            </div>
            <header>
                <div class="row">
                    <div class="columns xsmall-7 small-7 medium-8 large-8 xlarge-9">
                        <div class="logo">
                            <a href="/startseite" class="show-for-large hide-for-xsmall-only">
                                <img src="/decorations/layout/ingrid/images/template/logo.png" alt="RLP"/>
                                <div class="vertical-line"></div>
                                <span>PortalU</span>
                                <p>Umweltportal<br>Rheinland-Pfalz</p>
                            </a>
                    ...
                    <div class="columns xsmall-14 small-15 medium-14 large-13 xlarge-10 nav-tabs">
                        <div class="menu-tab-row">
                            ...
                            <a class="menu-tab " href="/datenkataloge" title="Themen">
                                <div class="link-menu-tab">
                ...
                <div class="footer">
                    ...
                    <div class="row">
                        <div class="xsmall-24 medium-24 large-24 xlarge-9 columns">
                            <div class="logo">
                                <a href="/startseite"><img class="footer__logo" src="/decorations/layout/ingrid/images/template/logo.png" alt="PortalU"/></a>
                            </div>
                            <div class="copyright">
