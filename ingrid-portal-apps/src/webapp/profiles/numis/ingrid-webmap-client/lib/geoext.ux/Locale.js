...
Local = {
    ...
    localizedStrings: {
        ...
        tHintZoomToView : { en: '<p class="hint">You may have to zoom into the map to see the layers of the external service. The provider of the service is responsible for the display of the service. NUMIS has no influence here.</p>', de: '<p class="hint">Nutzen Sie zur Darstellung einzelner Layer die Zoom-Funktion. F&uuml;r die Inhalte des Dienstes ist der jeweilige Betreiber verantwortlich.</p>' },
        ...
        tWelcomeTextTransparency: { en: 'Apply layer <strong>transparency</strong> using the slider control', de: 'Steuert die Layer-Sichtbarkeit mithilfe eines Schiebereglers'},
