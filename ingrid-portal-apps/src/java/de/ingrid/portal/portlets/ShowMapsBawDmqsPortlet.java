    ...
    public void serveResource(ResourceRequest request, ResourceResponse response) throws IOException {
        ...
        try {
            if (resourceID.equals( "marker" )) {
                ...
                IBusQueryResultIterator it = new IBusQueryResultIterator( QueryStringParser.parse( "http ranking:score" ), REQUESTED_FIELDS_MARKER, IBUSInterfaceImpl.getInstance()
                        .getIBus() );
                while (it.hasNext()) {
