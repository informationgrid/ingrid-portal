...
abstract class SearchExtEnvTopic extends SearchExtEnv {
    ...
    protected final static String PAGE_TERMS = "/portal/search-extended/search-ext-env-topic-terms.psml";

    protected final static String PAGE_THESAURUS = "/portal/search-extended/search-ext-env-topic-thesaurus.psml";
