 ...
 *
 * NOTICE: this portlet has almost the same functionality of the SearchExtEnvTopicThesaurusPortlet.
 *
 * @author joachim@wemove.com
 */
public class SearchExtLawTopicThesaurusPortlet extends SearchExtLawTopic {

    // VIEW TEMPLATES

    private final static String TEMPLATE_START = "/WEB-INF/templates/search_extended/search_ext_law_topic_thesaurus.vm";

    private final static String TEMPLATE_RESULTS = "/WEB-INF/templates/search_extended/search_ext_law_topic_thesaurus_results.vm";

    private final static String TEMPLATE_BROWSE = "/WEB-INF/templates/search_extended/search_ext_law_topic_thesaurus_browse.vm";

    private final static String TEMPLATE_SYNONYM = "/WEB-INF/templates/search_extended/search_ext_law_topic_thesaurus_synonym.vm";
    ...
    public void doView(javax.portlet.RenderRequest request, javax.portlet.RenderResponse response)
        ...
        SearchExtLawTopicThesaurusForm f = (SearchExtLawTopicThesaurusForm) Utils.getActionForm(request, SearchExtLawTopicThesaurusForm.SESSION_KEY, SearchExtLawTopicThesaurusForm.class);        
    ...
    public void processAction(ActionRequest request, ActionResponse actionResponse) throws PortletException,
        ...
        if (submittedSearch != null) {
            ...
            if (f.validate()) {
                ...
                try {
                    query = QueryStringParser.parse(f.getInput(SearchExtLawTopicThesaurusForm.FIELD_SEARCH_TERM));
