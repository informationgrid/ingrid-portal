...
public class MyPortalPasswordForgottenPortlet extends GenericVelocityPortlet {
    ...
    private static final String TEMPLATE_PASSWORD_SENT = "/WEB-INF/templates/myportal/myportal_password_forgotten_done.vm";
    ...
    public void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException {
        ...
        PasswordForgottenForm f = (PasswordForgottenForm) Utils.getActionForm(request, PasswordForgottenForm.SESSION_KEY, PasswordForgottenForm.class);        
        ...
        if (cmd == null) {
            ...
            request.setAttribute(GenericServletPortlet.PARAM_VIEW_PAGE, TEMPLATE_PASSWORD_SENT);
        }
    ...
    public void processAction(ActionRequest request, ActionResponse actionResponse) throws PortletException, IOException {
        ...
        try {
            ...
            f.setError(f.FIELD_EMAIL, "account.password_forgotten.error.email.notexists");
            return;
        }
        ...
        try {
            ...
            IngridResourceBundle messages = new IngridResourceBundle(getPortletConfig().getResourceBundle(
                    request.getLocale()));
            String emailSubject = messages.getString("account.password.forgotten.email.subject");
