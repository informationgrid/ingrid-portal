 ...
 */
public class SearchExtEnvTimeChronicleForm extends ActionForm {

    private static final long serialVersionUID = -3243020432308518967L;
    
    /** attribute name of action form in session */
    public static final String SESSION_KEY = SearchExtEnvTimeChronicleForm.class.getName();
    ...
    public boolean validate() {
        ...
        if (!hasInput(FIELD_SEARCH_TERM)) {
            setError(FIELD_SEARCH_TERM, "searchExtEnvTimeChronicle.error.no_term");
            valid = false;
        }
        return valid;
    }
