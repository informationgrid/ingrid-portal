...
public class DetailDataPreparerIdc1_0_2Address implements DetailDataPreparer {
    ...
    private final static Logger log = LoggerFactory.getLogger(DetailDataPreparerIdc1_0_2Address.class);
	...
	public DetailDataPreparerIdc1_0_2Address(Context context, String iPlugId, RenderRequest request, RenderResponse response) {
