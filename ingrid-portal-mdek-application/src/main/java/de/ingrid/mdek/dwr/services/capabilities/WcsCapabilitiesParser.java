 ...
 *
 */
public class WcsCapabilitiesParser extends GeneralCapabilitiesParser implements ICapabilitiesParser {
    ...
    private static final String XPATH_EXP_WCS_ONLINE_RESOURCE = "/wcs:WCS_Capabilities/wcs:Service/wcs:responsibleParty/wcs:contactInfo/wcs:onlineResource";
    private static final String XPATH_EXP_WCS_KEYWORDS = "/wcs:WCS_Capabilities/wcs:ContentMetadata/wcs:CoverageOfferingBrief/wcs:keywords/wcs:keyword";

    
    public WcsCapabilitiesParser(SysListCache syslistCache) {
        super(new XPathUtils(new WcsNamespaceContext()), syslistCache);
    }
    ...
    public CapabilitiesBean getCapabilitiesData(Document doc) throws XPathExpressionException {
        ...
        result.setDataServiceType(6); // other
    ...
    private AddressBean getAddress(Document doc) {
        ...
        address.setStreet(xPathUtils.getString(doc, XPATH_EXT_WCS_SERVICECONTACT + "/wcs:contactInfo/wcs:address/wcs:deliveryPoint"));
        address.setCity(xPathUtils.getString(doc, XPATH_EXT_WCS_SERVICECONTACT + "/wcs:contactInfo/wcs:address/wcs:city"));
        address.setPostcode(xPathUtils.getString(doc, XPATH_EXT_WCS_SERVICECONTACT + "/wcs:contactInfo/wcs:address/wcs:postalCode"));
        address.setCountry(xPathUtils.getString(doc, XPATH_EXT_WCS_SERVICECONTACT + "/wcs:contactInfo/wcs:address/wcs:country"));
        address.setState(xPathUtils.getString(doc, XPATH_EXT_WCS_SERVICECONTACT + "/wcs:contactInfo/wcs:address/wcs:administrativeArea"));
        address.setPhone(xPathUtils.getString(doc, XPATH_EXT_WCS_SERVICECONTACT + "/wcs:contactInfo/wcs:phone/wcs:voice"));
