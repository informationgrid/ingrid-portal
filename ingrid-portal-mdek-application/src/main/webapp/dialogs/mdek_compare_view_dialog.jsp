    ...
    "ingrid/message"
        ...
        function renderNodeData(nodeDataOld, nodeDataNew) {
            ...
            if (nodeDataOld.objectClass == 1 || nodeDataNew.objectClass == 1) {
				...
				renderTextWithTitle(formatDate(nodeDataOld.availabilityDataFormatInspireDate), formatDate(nodeDataNew.availabilityDataFormatInspireDate), "<fmt:message key='ui.obj.availability.dataFormatInspireDate' />");
            }
