...
function renderNodeData(nodeData) {
	...
	deferred.addCallback(function(res) {
		...
		if (nodeData.objectClass == 1) {
            ...
            renderTable(nodeData.dq117Table, ["nameOfMeasure", "resultValue", "measureDescription"], ["<fmt:message key='ui.obj.dq.table.header1' />", "<fmt:message key='ui.obj.dq.table.header2' />", "<fmt:message key='ui.obj.dq.table.header3' />"], "<fmt:message key='ui.obj.dq.table117.title' />");
		...
		renderList(nodeData.thesaurusEnvCatsList, "<fmt:message key='ui.obj.thesaurus.terms.enviromental.title' />"+ " - " + "<fmt:message key='ui.obj.thesaurus.terms.enviromental.categories' />", null, function (val) { return UtilSyslist.getSyslistEntryName(1400, val);});
