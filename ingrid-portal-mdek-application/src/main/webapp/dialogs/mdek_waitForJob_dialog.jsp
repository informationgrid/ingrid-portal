...
require(["dojo/on",
    ...
    waitForJobDlg = {
        cancelButtonFunc: cancelButtonFunc
    };
});
...
<body>
	<div id="contentPane" layoutAlign="client" class="">
        ...
        <div id="dialogButtonBar" class="dijitDialogPaneActionBar">
            <button data-dojo-type="dijit/form/Button" title="<fmt:message key="dialog.waitForJob.cancel" />" onclick="waitForJobDlg.cancelButtonFunc"><fmt:message key="dialog.waitForJob.cancel" /></button>
        </div>
	</div>
</body>
</html>
