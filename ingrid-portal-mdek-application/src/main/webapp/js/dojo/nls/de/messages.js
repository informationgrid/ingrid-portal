(
  {
	...
	"operation.error.address.referencedAddressesHaveSmallerPublicationCondition":"Die Adressen ${0} besitzen eine geringere Veröffentlichung. Ändern Sie die Veröffentlichung am Objekt oder an den Adressen, um das Objekt zu veröffentlichen.",
	...
	"operation.hint.publicationConditionSaveHint.address":"Die Ver&ouml;ffentlichungsbreite der Adressen im nachgeordneten Teilbaum ist gr&ouml;&szlig;er als die, die f&uuml;r die aktuelle Adresse ausgew&auml;hlt wurde (in den veröffentlichten Versionen).<br>Mit dem Veröffentlichen der aktuellen Adresse werden alle nachgeordneten veröffentlichten(!) Adressen auf die gew&auml;hlte Ver&ouml;ffentlichungsbreite gesetzt.<br>Soll die Adresse wirklich gespeichert werden?",
