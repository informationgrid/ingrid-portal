...
//	var comboBox = dojo.widget.byId("testComboBox");
//	comboBox.dataProvider.searchLimit = 1000;
});
...
<select dojoType="ingrid:ComboBox">
...
Standard ComboBox with searchLimit = 1000 (default)

<br>
<select dojoType="ingrid:ComboBox" searchLimit="30">
	<option value='af'>Afghanistan</option>
	<option value='eg'>&Auml;gypten</option>
	<option value='al'>Albanien</option>
	<option value='dz'>Algerien</option>
...
ComboBox with searchLimit = 30
<br>

<select dojoType="ingrid:ComboBox" searchLimit="500">
	<option value='af'>Afghanistan</option>
	<option value='eg'>&Auml;gypten</option>
	<option value='al'>Albanien</option>
	<option value='dz'>Algerien</option>
...
ComboBox with searchLimit = 500

<br><br>
<select dojoType="ingrid:Select">
	<option value='af'>Afghanistan</option>
	<option value='eg'>&Auml;gypten</option>
	<option value='al'>Albanien</option>
	<option value='dz'>Algerien</option>
...
Standard Select with searchLimit = 1000 (default)
<br>
<select dojoType="ingrid:Select" searchLimit="30">
	<option value='af'>Afghanistan</option>
	<option value='eg'>&Auml;gypten</option>
	<option value='al'>Albanien</option>
	<option value='dz'>Algerien</option>
...
Select with searchLimit = 30
<br>
<select dojoType="ingrid:Select" searchLimit="500">
	<option value='af'>Afghanistan</option>
	<option value='eg'>&Auml;gypten</option>
	<option value='al'>Albanien</option>
	<option value='dz'>Algerien</option>
