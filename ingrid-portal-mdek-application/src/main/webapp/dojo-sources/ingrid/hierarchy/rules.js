        ...
        return declare(null, {
            ...
            applyRule1: function() {
                ...
                if (array.some(tableData, function(item) {
                    ...
                    registry.byId("ref1VFormatTopology").setDisabled(false);
                    ...
                    registry.byId("ref1VFormatTopology").setValue(null);
                    registry.byId("ref1VFormatTopology").setDisabled(true);
            ...
            applyRule7: function() {
                ...
                var objectClassStr = registry.byId("objectClass").getValue().toLowerCase(); // Value is a string: "Classx" where x is the class
            ...
            applyRuleThesaurusInspire: function() {
                ...
                aspect.after(UtilGrid.getTable("thesaurusInspire"), "onCellChange", function(msg) {
                    var objClass = registry.byId("objectClass").getValue();
