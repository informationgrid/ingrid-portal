define({
    root: {
        ...
        "tree.selectNodeCopyUuidHint": "If you insert a copy of this metadata at another location, then this object will get a new UUID!<br/><br/>Moreover any eventually given 'Parent Identifier' will be removed, if not pasted under a folder or the Object-node.<br/><br/>Please note that a new object is created, which is not identical to the original onea and which cannot be found under the old UUID! If you want to move an object including its identity then you have to use the operation \"Cut Objects / Addresses / Subtrees\" and \"Paste\".",
        "tree.moveNodeParentIdentifierHint": "When moving an object any eventually given 'Parent Identifier' will be removed, if not pasted under a folder or the Object-node.",
