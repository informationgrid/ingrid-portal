define({
    ...
    "tree.folder": "Ordner",
    "tree.folder.new": "Neuer Ordner",
    "tree.folder.create": "Ordner erstellen",
    ...
    "ui.obj.spatial.regionKeyHelp": "Amtlicher Regionalschl&uuml;ssel (ARS) des Statistischen Bundesamtes, hier als erg&auml;nzende Angabe zur BoundingBox. Es sind nur jene Ziffern des ARS anzugeben, die die jeweilige administrative Ebene abbilden (Gemeinde: alle 12 Stellen; Gemeindeverband: die ersten 9 Stellen; Bundesland: die ersten 2 Stellen. Der Nationalstaat 'Bundesrepublik Deutschland' wird mit '000000000000' angegeben (12 mal die '0')). Die Angabe des Regionalschl&uuml;ssels erm&ouml;glicht die Pr&auml;zisierung der Beschreibung der r&auml;umlichen Ausdehung einer Geodatenressource und sollte nur angegeben werden, wenn der geometrische Umring einer administrativen Einheit zutreffend ist und die Geodatenressource vollständig darin liegt.<br><br>&Uuml;ber <a href='https://opengovtech.de/ars/' target='_blank'>https://opengovtech.de/ars/</a> k&ouml;nnen Sie einen Amtlichen Regionalschl&uuml;ssel suchen.",
    ...
    "ui.obj.additionalInfo.conformityTable.link": "Konformit&auml;t hinzuf&uuml;gen",
    ...
    "ui.obj.additionalInfo.conformityTable.header.explanation": "gepr&uuml;ft mit",
    "ui.obj.additionalInfo.xmlExportCriteria": "XML-Export-Kriterium",
    "ui.obj.additionalInfo.legalBasis": "Weitere Rechtliche Grundlagen",
    ...
    "ui.obj.dq.table128.title": "Relative Positionsgenauigkeit",
    ...
    "ui.1350.description": "Weitere Rechtliche Grundlagen",
    ...
    "ui.N025.description": "Zugriffsbeschr&auml;nkungen",
    "ui.N026.description": "Anwendungseinschr&auml;nkungen",
    "ui.N027.description": "Nutzungsbedingungen",
    ...
    "ui.sysList.1350": "Weitere Rechtliche Grundlagen",
    ...
    "ui.sysList.7128": "Datenqualität - Relative Positionsgenauigkeit - Art der Messung",
    ...
    "validation.error.conformity.table": "Es müssen alle Pflichtfelder eingetragen werden. Alle Einträge in der Tabelle müssen einen gültigen Level und Spezifikation haben.",
    ...
    "validation.error.spatial.bounding.box": "Die L&auml;nge 2 muss gr&ouml;&szlig;er als die L&auml;nge 1 sein sowie die Breite 2 gr&ouml;&szlig;er als die Breite 1 sein muss.",
    ...
    "validation.specification.missing": "Die Spezifikation <ul><li>${0}</li></ul> muss auf 'nicht evaluiert' oder 'nicht konform' gesetzt sein, entsprechend den Einstellungen im Bereich 'Allgemeines', Checkbox 'INSPIRE-relevant' mit Radiobutton 'nicht konform'.",
    "validation.specification.missing.service": "Die Spezifikation <ul><li>${0}</li></ul> muss für Geodatendienste vorhanden sein, entsprechend der aktivierten Checkbox 'INSPIRE-relevant' im Bereich 'Allgemeines'.",
    "validation.specification.conform.missing": "Die Spezifikation <ul><li>${0}</li></ul> muss auf 'konform' gesetzt sein, entsprechend den Einstellungen im Bereich 'Allgemeines', Checkbox 'INSPIRE-relevant' mit Radiobutton 'konform'.",
    ...
    "hint.selectOpenDataInspire": "Wird diese Auswahl gewählt, so werden alle Zugriffsbeschränkungen entfernt und durch 'keine' ersetzt. Möchten Sie fortfahren?",
    "hint.selectOpenData": "Wird diese Auswahl gewählt, so werden alle Zugriffsbeschränkungen entfernt. Möchten Sie fortfahren?",
