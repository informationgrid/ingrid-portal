...
//		renderOperations(nodeData.ref3Operation);
    ...
    renderTextWithTitle(nodeDataOld.availabilityDataFormatInspire, nodeDataNew.availabilityDataFormatInspire, message.get("ui.obj.availability.dataFormatInspire"));
