...
<body style="margin:0; padding:0;width:100%; height:100%; overflow:auto;font:normal 11px/16px Verdana, Helvetica, Arial, sans-serif;">
	<div class="head-menu">
  	    <div id="logo" class="float-left"><img src="img/logo.gif" width="119" height="24" alt="PortalU" /></div>
  		  <div id="title" class="float-left"><img src="img/title_erfassung.gif" width="158" height="24" alt="Metadatenerfassung" /></div>
  	    <ul>
  	      <li><a href="mdek_help.jsp?hkey=index">INDEX</a></li>
  	      <li class="separator">|</li>
  	      <li><a href="javascript:window.close()">SCHLIESSEN</a></li>
  	    </ul>
    </div>
